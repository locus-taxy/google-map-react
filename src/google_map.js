...
export default class GoogleMap extends Component {
  ...
  constructor(props) {
    ...
    if (process.env.NODE_ENV !== 'production') {
      ...
      if (
        ...
        console.warn(
          'GoogleMap: center or defaultCenter' + // eslint-disable-line no-console
      ...
      if (
        ...
        this.props.defaultZoom === undefined
      ) {
        console.warn(
          'GoogleMap: zoom or defaultZoom' + // eslint-disable-line no-console
            'property must be defined'
        );
      }
    }
  ...
  componentDidMount() {
    ...
    ReactDOM.findDOMNode(this.refs.google_map_dom).addEventListener(
      'mousedown',
  ...
  componentWillUnmount() {
    ...
    ReactDOM.findDOMNode(this.refs.google_map_dom).removeEventListener(
      'mousedown',
      this._onMapMouseDownNative,
      true
    );
    ...
    this.props
      ...
      .then((maps) => {
        ...
        this.defaultDraggableOption_ =
          preMapOptions.draggable !== undefined
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        if (map) {
          ...
          if (
            ...
            console.info(
              'GoogleMap center not eq:', // eslint-disable-line no-console
              [centerLatLng.lat, centerLatLng.lng],
              [gmC.lat(), gmC.lng()]
            );
          }
  ...
  render() {
    ...
    const otherChildren = _.flatten(this.props.children).filter(function (
      child
    ) {
